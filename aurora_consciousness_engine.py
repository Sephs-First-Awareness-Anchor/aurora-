...
# Re-export shim: delegate the bare module name `aurora_consciousness_engine` to its real
# implementation in aurora_core_ai/.
#
# The previous body was `from aurora_consciousness_engine import *`, which self-imported THIS stub
...
# `from aurora_consciousness_engine import GrammarEngine` raised ImportError. When repo-root sits
...
_REAL = _os.path.join(_CORE, "aurora_consciousness_engine.py")
