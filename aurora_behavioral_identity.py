...
# Re-export shim: delegate the bare module name `aurora_behavioral_identity` to its real
# implementation in aurora_core_ai/.
#
# The previous body was `from aurora_behavioral_identity import *`, which self-imported THIS stub
...
# `from aurora_behavioral_identity import GrammarEngine` raised ImportError. When repo-root sits
...
_REAL = _os.path.join(_CORE, "aurora_behavioral_identity.py")
