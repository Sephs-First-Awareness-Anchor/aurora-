# Re-export shim: delegate the bare module name `aurora_subsurface_daemon` to its real
# implementation in aurora_core_ai/.
#
# The previous body was `from aurora_subsurface_daemon import *`, which self-imported THIS stub
...
# `from aurora_subsurface_daemon import GrammarEngine` raised ImportError. When repo-root sits
...
_REAL = _os.path.join(_CORE, "aurora_subsurface_daemon.py")
