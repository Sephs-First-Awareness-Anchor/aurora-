...
class DimensionalSystems:
    ...
    def set_field_map(self, field_map) -> None:
        """Attach a ConstraintFieldAccumulator as a read-only observer of PressureVec.

        The accumulator receives updates on every _current_pressure_vec() call but
        never writes back to DimensionalSystems or RuntimeConstraintGovernor.
        Pass None to detach.
        """
        self.field_map = field_map
    ...
    def _ensure_genealogy_symbols() -> bool:
        ...
        global constraints_for_operation, axis_token, GENEALOGY_AVAILABLE
...
_AURORA_NATIVE_STRATEGIES = {'CrystalProcessingSystem.process.develop_agency': {'ability_hits': 0,
                                                    'alignment_gap': 0.0,
                                                    ...
                                                    'effect_phrases': ['would extend agency '
                                                                       ...
                                                                       'aurora_dimensional_systems.CrystalProcessingSystem.process'],
                                                    'genealogy_pressure': 0.0,
                                                    'inheritance_breach_count': 0,
                                                    'kind': 'latent',
                                                    'link_hits': 0,
                                                    'module': 'aurora_dimensional_systems',
                                                    'op_id': 'latent.aurora_dimensional_systems.CrystalProcessingSystem.process.develop_agency',
                                                    'origin_activity': 0,
                                                    ...
                                                    'signature': '',
                                                    'surface_score': 0.7340000000000001,
                                                    'sustainability_score': 0.0,
                                                    'target_kind': 'latent_operation'},
 'DimensionalSystems._current_pressure_vec': {'ability_hits': 5,
                                              'alignment_gap': 0.553999,
                                              'alignment_target_score': 1.002666,
                                              'best_coupling_signature': 'T^2*N^2',
                                              'constraints': ['temporal', 'energy'],
                                              'contract_profile': {'accepts_payload': False,
                                                                   'async_callable': False,
                                                                   'callable': True,
                                                                   'class_target': False,
                                                                   ...
                                                                   'optional_args': 0,
                                                                   'required_args': 0,
                                                                   'return_hint': "Optional['PressureVec']",
                                                                   'signature_text': '(self) -> '
                                                                                     '"Optional[\'PressureVec\']"',
                                                                   'stateful_owner': True,
                                              ...
                                              'effect_modes': ['temporal_orchestration_change',
                                                               'cost_pressure_change',
                                                               'behavioral_execution_surface',
                                                               'core_subsystem_surface'],
                                              'effect_phrases': ['changed ordering, tick flow, or '
                                                                 'replay behavior',
                                                                 'changed cost, pressure, or '
                                                                 'maintenance economics',
                                                                 'introduced executable behavior '
                                                                 'surface'],
                                              'genealogy_pressure': 0.550328,
                                              'inheritance_breach_count': 1,
                                              'kind': 'reflection',
                                              'link_hits': 10,
                                              'module': 'aurora_dimensional_systems',
                                              'op_id': 'aurora_dimensional_systems.DimensionalSystems._current_pressure_vec',
                                              'origin_activity': 0,
                                              'persistence_tax_factor': 1.016424,
                                              'representation_score': 0.624762,
                                              ...
                                              'rewrite_profile': 'dimensional_balancing',
                                              'signature': 'T^2*N^2',
                                              'surface_score': 0.448667,
                                              'sustainability_score': 0.553345,
                                              'target_kind': 'function'},
 'DimensionalSystems.develop_agency': {'ability_hits': 0,
                                       'alignment_gap': 0.0,
                                       'alignment_target_score': 0.0,
                                       'best_coupling_signature': '',
                                       ...
                                       'effect_phrases': ['would extend agency pressure handling',
                                                          ...
                                                          'implied by '
                                                          'aurora_dimensional_systems.DimensionalSystems'],
                                       'genealogy_pressure': 0.0,
                                       'inheritance_breach_count': 0,
                                       'kind': 'latent',
                                       'link_hits': 0,
                                       'module': 'aurora_dimensional_systems',
                                       'op_id': 'latent.aurora_dimensional_systems.DimensionalSystems.develop_agency',
                                       'origin_activity': 0,
                                       'persistence_tax_factor': 0.0,
                                       'representation_score': 0.0,
                                       'rewrite_bias': 'generic',
                                       ...
                                       'rewrite_profile': 'dimensional_balancing',
                                       'signature': '',
                                       'surface_score': 1.0010000000000001,
                                       'sustainability_score': 0.0,
                                       'target_kind': 'latent_operation'},
 'EnergyRegulatorSystem._update_links_for_facet': {'ability_hits': 19,
                                                   'alignment_gap': 0.568999,
                                                   'alignment_target_score': 1.002666,
                                                   ...
                                                   'effect_modes': ['cost_pressure_change',
                                                                    ...
                                                                    'behavioral_execution_surface',
                                                                    'core_subsystem_surface'],
                                                   'effect_phrases': ['changed cost, pressure, or '
                                                                      'maintenance economics',
                                                                      'changed module interfaces '
                                                                      'or coupling boundaries',
                                                   ...
                                                   'link_hits': 38,
                                                   'module': 'aurora_dimensional_systems',
                                                   'op_id': 'aurora_dimensional_systems.EnergyRegulatorSystem._update_links_for_facet',
                                                   'origin_activity': 0,
                                                   'persistence_tax_factor': 1.422994,
                                                   'representation_score': 0.482779,
                                                   'rewrite_bias': 'dimensional_balancing',
                                                   'rewrite_feedback': {'acceptance_rate': 0.0,
                                                                        'accepted_count': 0,
                                                                        'adaptation_mode': 'integrative',
                                                   ...
                                                   'rewrite_profile': 'dimensional_balancing',
                                                   'signature': 'N^2*B^2',
                                                   'surface_score': 0.433667,
                                                   'sustainability_score': 0.498642,
                                                   'target_kind': 'function'},
 'EnergyRegulatorSystem.develop_agency': {'ability_hits': 0,
                                          'alignment_gap': 0.0,
                                          'alignment_target_score': 0.0,
                                          'best_coupling_signature': '',
                                          'constraints': ['energy', 'agency'],
                                          'contract_profile': {'accepts_payload': False,
                                                               'async_callable': False,
                                                               'callable': False,
                                                               'class_target': False,
                                          ...
                                          'effect_phrases': ['would extend agency pressure '
                                                             ...
                                                             'would materialize the next '
                                                             'descendant implied by '
                                                             'aurora_dimensional_systems.EnergyRegulatorSystem'],
                                          'genealogy_pressure': 0.0,
                                          'inheritance_breach_count': 0,
                                          'kind': 'latent',
                                          'link_hits': 0,
                                          'module': 'aurora_dimensional_systems',
                                          'op_id': 'latent.aurora_dimensional_systems.EnergyRegulatorSystem.develop_agency',
                                          'origin_activity': 0,
                                          'persistence_tax_factor': 0.0,
                                          'representation_score': 0.0,
                                          'rewrite_bias': 'generic',
                                          ...
                                          'rewrite_profile': 'dimensional_balancing',
                                          'signature': '',
                                          'surface_score': 1.0355008,
                                          'sustainability_score': 0.0,
                                          'target_kind': 'latent_operation'},
 'EnergyRegulatorSystem.tick': {'ability_hits': 5,
                                'alignment_gap': 0.560666,
                                'alignment_target_score': 1.002666,
                                'best_coupling_signature': 'T^2*N^2',
                                'constraints': ['temporal', 'energy'],
                                'contract_profile': {'accepts_payload': False,
                                                     ...
                                                     'constraint_density': 2,
                                                     'contract_mode': 'stateful',
                                                     'doc_hint': 'Full physics tick. Restored from '
                                                                 'original:',
                                                     'effect_density': 4,
                                                     'kwonly_args': 0,
                                                     'optional_args': 1,
                                ...
                                'effect_modes': ['temporal_orchestration_change',
                                                 ...
                                                 'behavioral_execution_surface',
                                                 'core_subsystem_surface'],
                                'effect_phrases': ['changed ordering, tick flow, or replay '
                                                   'behavior',
                                                   'changed cost, pressure, or maintenance '
                                                   'economics',
                                ...
                                'link_hits': 10,
                                'module': 'aurora_dimensional_systems',
                                'op_id': 'aurora_dimensional_systems.EnergyRegulatorSystem.tick',
                                'origin_activity': 0,
                                'persistence_tax_factor': 1.016424,
                                'representation_score': 0.624762,
                                'rewrite_bias': 'dimensional_balancing',
                                ...
                                'sustainability_score': 0.553345,
                                'target_kind': 'function'},
 'EvolutionTracker.develop_agency': {'ability_hits': 0,
                                     'alignment_gap': 0.0,
                                     'alignment_target_score': 0.0,
                                     'best_coupling_signature': '',
                                     'constraints': ['existence', 'temporal', 'agency'],
                                     ...
                                     'effect_phrases': ['would extend agency pressure handling',
                                                        'would materialize the next descendant '
                                                        'implied by '
                                                        'aurora_dimensional_systems.EvolutionTracker'],
                                     'genealogy_pressure': 0.0,
                                     'inheritance_breach_count': 0,
                                     'kind': 'latent',
                                     'link_hits': 0,
                                     'module': 'aurora_dimensional_systems',
                                     'op_id': 'latent.aurora_dimensional_systems.EvolutionTracker.develop_agency',
                                     'origin_activity': 0,
                                     'persistence_tax_factor': 0.0,
                                     'representation_score': 0.0,
                                     'rewrite_bias': 'generic',
                                     ...
                                     'sustainability_score': 0.0,
                                     'target_kind': 'latent_operation'},
 'MemoryConstantSystem.develop_agency': {'ability_hits': 0,
                                         'alignment_gap': 0.0,
                                         'alignment_target_score': 0.0,
                                         'best_coupling_signature': '',
                                         'constraints': ['existence', 'temporal', 'agency'],
                                         ...
                                         'effect_phrases': ['would extend agency pressure handling',
                                                            'would materialize the next descendant '
                                                            'implied by '
                                                            'aurora_dimensional_systems.MemoryConstantSystem'],
                                         'genealogy_pressure': 0.0,
                                         'inheritance_breach_count': 0,
                                         'kind': 'latent',
                                         'link_hits': 0,
                                         'module': 'aurora_dimensional_systems',
                                         'op_id': 'latent.aurora_dimensional_systems.MemoryConstantSystem.develop_agency',
                                         'origin_activity': 0,
                                         'persistence_tax_factor': 0.0,
                                         'representation_score': 0.0,
                                         'rewrite_bias': 'generic',
                                         ...
                                         'sustainability_score': 0.0,
                                         'target_kind': 'latent_operation'},
 'MoralityMortalitySystem.develop_agency': {'ability_hits': 0,
                                            'alignment_gap': 0.0,
                                            'alignment_target_score': 0.0,
                                            'best_coupling_signature': '',
                                            'constraints': ['existence', 'temporal', 'agency'],
                                            ...
                                            'effect_phrases': ['would extend agency pressure '
                                                               ...
                                                               'would materialize the next '
                                                               'descendant implied by '
                                                               'aurora_dimensional_systems.MoralityMortalitySystem'],
                                            'genealogy_pressure': 0.0,
                                            'inheritance_breach_count': 0,
                                            'kind': 'latent',
                                            'link_hits': 0,
                                            'module': 'aurora_dimensional_systems',
                                            'op_id': 'latent.aurora_dimensional_systems.MoralityMortalitySystem.develop_agency',
                                            'origin_activity': 0,
                                            'persistence_tax_factor': 0.0,
                                            'representation_score': 0.0,
                                            'rewrite_bias': 'generic',
                                            ...
                                            'rewrite_profile': 'dimensional_balancing',
                                            'signature': '',
                                            'surface_score': 0.74765625,
                                            'sustainability_score': 0.0,
                                            'target_kind': 'latent_operation'},
 '_PoolView.energy.develop_agency': {'ability_hits': 0,
                                     'alignment_gap': 0.0,
                                     'alignment_target_score': 0.0,
                                     'best_coupling_signature': '',
                                     'constraints': ['energy', 'agency'],
                                     ...
                                     'effect_phrases': ['would extend agency pressure handling',
                                                        'would materialize the next descendant '
                                                        'implied by '
                                                        'aurora_dimensional_systems._PoolView.energy'],
                                     'genealogy_pressure': 0.0,
                                     'inheritance_breach_count': 0,
                                     'kind': 'latent',
                                     'link_hits': 0,
                                     'module': 'aurora_dimensional_systems',
                                     'op_id': 'latent.aurora_dimensional_systems._PoolView.energy.develop_agency',
                                     'origin_activity': 0,
                                     'persistence_tax_factor': 0.0,
                                     'representation_score': 0.0,
                                     'rewrite_bias': 'generic',
                                     ...
                                     'rewrite_profile': 'dimensional_balancing',
                                     'signature': '',
                                     'surface_score': 0.73486005,
                                     'sustainability_score': 0.0,
                                     'target_kind': 'latent_operation'},
 '_PoolView.inject': {'ability_hits': 12,
                      'alignment_gap': 0.567333,
                      'alignment_target_score': 1.002666,
...
def develop_agency(payload=None, **kwargs):
    ...
    if engine is None:
        return {
            'available': False, 'reason': 'evolved_surface_engine_unavailable', 'op_id': 'latent.aurora_dimensional_systems.EvolutionTracker.develop_agency', 'kind': 'latent'
        }
    return getattr(engine, 'latent_aurora_dimensional_systems_evolutiontracker_develop_agency')(payload=payload, **kwargs)

_aurora_existing_binding = _aurora_get_target(['EvolutionTracker'])
if _aurora_existing_binding is not None:
    _aurora_existing_attr = getattr(_aurora_existing_binding, 'develop_agency', None)
    if _aurora_existing_attr is None or getattr(_aurora_existing_attr, '_aurora_latent_binding_target', '') == 'EvolutionTracker.develop_agency':
        _aurora_bind_owner_attribute(['EvolutionTracker'], 'develop_agency', _aurora_make_latent_binding('develop_agency', 'EvolutionTracker.develop_agency'))
        _AURORA_NATIVE_EVOLVED_LAST['EvolutionTracker.develop_agency'] = {'latent_binding_active': True}

def dimensionalsystems_develop_agency(payload=None, **kwargs):
    engine = _aurora_native_evolved_engine()
    if engine is None:
        return {
            'available': False, 'reason': 'evolved_surface_engine_unavailable', 'op_id': 'latent.aurora_dimensional_systems.DimensionalSystems.develop_agency', 'kind': 'latent'
        }
    return getattr(engine, 'latent_aurora_dimensional_systems_dimensionalsystems_develop_agency')(payload=payload, **kwargs)

_aurora_existing_binding = _aurora_get_target(['DimensionalSystems'])
if _aurora_existing_binding is not None:
    _aurora_existing_attr = getattr(_aurora_existing_binding, 'develop_agency', None)
    if _aurora_existing_attr is None or getattr(_aurora_existing_attr, '_aurora_latent_binding_target', '') == 'DimensionalSystems.develop_agency':
        _aurora_bind_owner_attribute(['DimensionalSystems'], 'develop_agency', _aurora_make_latent_binding('dimensionalsystems_develop_agency', 'DimensionalSystems.develop_agency'))
        _AURORA_NATIVE_EVOLVED_LAST['DimensionalSystems.develop_agency'] = {'latent_binding_active': True}

def energyregulatorsystem_develop_agency(payload=None, **kwargs):
    engine = _aurora_native_evolved_engine()
    if engine is None:
        return {
            'available': False, 'reason': 'evolved_surface_engine_unavailable', 'op_id': 'latent.aurora_dimensional_systems.EnergyRegulatorSystem.develop_agency', 'kind': 'latent'
        }
    return getattr(engine, 'latent_aurora_dimensional_systems_energyregulatorsystem_develop_agency')(payload=payload, **kwargs)

_aurora_existing_binding = _aurora_get_target(['EnergyRegulatorSystem'])
if _aurora_existing_binding is not None:
    _aurora_existing_attr = getattr(_aurora_existing_binding, 'develop_agency', None)
    if _aurora_existing_attr is None or getattr(_aurora_existing_attr, '_aurora_latent_binding_target', '') == 'EnergyRegulatorSystem.develop_agency':
        _aurora_bind_owner_attribute(['EnergyRegulatorSystem'], 'develop_agency', _aurora_make_latent_binding('energyregulatorsystem_develop_agency', 'EnergyRegulatorSystem.develop_agency'))
        _AURORA_NATIVE_EVOLVED_LAST['EnergyRegulatorSystem.develop_agency'] = {'latent_binding_active': True}

def moralitymortalitysystem_develop_agency(payload=None, **kwargs):
    engine = _aurora_native_evolved_engine()
    if engine is None:
        return {
            'available': False, 'reason': 'evolved_surface_engine_unavailable', 'op_id': 'latent.aurora_dimensional_systems.MoralityMortalitySystem.develop_agency', 'kind': 'latent'
        }
    return getattr(engine, 'latent_aurora_dimensional_systems_moralitymortalitysystem_develop_agency')(payload=payload, **kwargs)

_aurora_existing_binding = _aurora_get_target(['MoralityMortalitySystem'])
if _aurora_existing_binding is not None:
    _aurora_existing_attr = getattr(_aurora_existing_binding, 'develop_agency', None)
    if _aurora_existing_attr is None or getattr(_aurora_existing_attr, '_aurora_latent_binding_target', '') == 'MoralityMortalitySystem.develop_agency':
        _aurora_bind_owner_attribute(['MoralityMortalitySystem'], 'develop_agency', _aurora_make_latent_binding('moralitymortalitysystem_develop_agency', 'MoralityMortalitySystem.develop_agency'))
        _AURORA_NATIVE_EVOLVED_LAST['MoralityMortalitySystem.develop_agency'] = {'latent_binding_active': True}

def energy_develop_agency(payload=None, **kwargs):
    engine = _aurora_native_evolved_engine()
    if engine is None:
        return {
            'available': False, 'reason': 'evolved_surface_engine_unavailable', 'op_id': 'latent.aurora_dimensional_systems._PoolView.energy.develop_agency', 'kind': 'latent'
        }
    return getattr(engine, 'latent_aurora_dimensional_systems_poolview_energy_develop_agency')(payload=payload, **kwargs)

def process_develop_agency(payload=None, **kwargs):
    engine = _aurora_native_evolved_engine()
    if engine is None:
        return {
            'available': False, 'reason': 'evolved_surface_engine_unavailable', 'op_id': 'latent.aurora_dimensional_systems.CrystalProcessingSystem.process.develop_agency', 'kind': 'latent'
        }
    return getattr(engine, 'latent_aurora_dimensional_systems_crystalprocessingsystem_process_develop_agency')(payload=payload, **kwargs)

_aurora_existing_binding = _aurora_get_target(['CrystalProcessingSystem', 'process'])
if _aurora_existing_binding is not None:
    _aurora_existing_attr = getattr(_aurora_existing_binding, 'develop_agency', None)
    if _aurora_existing_attr is None or getattr(_aurora_existing_attr, '_aurora_latent_binding_target', '') == 'CrystalProcessingSystem.process.develop_agency':
        _aurora_bind_owner_attribute(['CrystalProcessingSystem', 'process'], 'develop_agency', _aurora_make_latent_binding('process_develop_agency', 'CrystalProcessingSystem.process.develop_agency'))
        _AURORA_NATIVE_EVOLVED_LAST['CrystalProcessingSystem.process.develop_agency'] = {'latent_binding_active': True}

def memoryconstantsystem_develop_agency(payload=None, **kwargs):
    engine = _aurora_native_evolved_engine()
    if engine is None:
        return {
            'available': False, 'reason': 'evolved_surface_engine_unavailable', 'op_id': 'latent.aurora_dimensional_systems.MemoryConstantSystem.develop_agency', 'kind': 'latent'
        }
    return getattr(engine, 'latent_aurora_dimensional_systems_memoryconstantsystem_develop_agency')(payload=payload, **kwargs)

_aurora_existing_binding = _aurora_get_target(['MemoryConstantSystem'])
if _aurora_existing_binding is not None:
    _aurora_existing_attr = getattr(_aurora_existing_binding, 'develop_agency', None)
    if _aurora_existing_attr is None or getattr(_aurora_existing_attr, '_aurora_latent_binding_target', '') == 'MemoryConstantSystem.develop_agency':
        _aurora_bind_owner_attribute(['MemoryConstantSystem'], 'develop_agency', _aurora_make_latent_binding('memoryconstantsystem_develop_agency', 'MemoryConstantSystem.develop_agency'))
        _AURORA_NATIVE_EVOLVED_LAST['MemoryConstantSystem.develop_agency'] = {'latent_binding_active': True}

def current_pressure_vec_evolved(payload=None, **kwargs):
    engine = _aurora_native_evolved_engine()
    if engine is None:
        return {
            'available': False, 'reason': 'evolved_surface_engine_unavailable', 'op_id': 'aurora_dimensional_systems.DimensionalSystems._current_pressure_vec', 'kind': 'reflection'
        }
    return getattr(engine, 'reflect_aurora_dimensional_systems_dimensionalsystems_current_pressure_vec')(payload=payload, **kwargs)

if _aurora_get_target(['DimensionalSystems', '_current_pressure_vec']) is not None:
    _AURORA_NATIVE_EVOLVED_ORIGINALS['DimensionalSystems._current_pressure_vec'] = _aurora_get_target(['DimensionalSystems', '_current_pressure_vec'])
    _aurora_assign_target(['DimensionalSystems', '_current_pressure_vec'], _aurora_make_override('current_pressure_vec_evolved', 'DimensionalSystems._current_pressure_vec'))
    _AURORA_NATIVE_EVOLVED_LAST['DimensionalSystems._current_pressure_vec'] = {'alignment_gap': 0.553999, 'override_active': True}

def update_links_for_facet_evolved(payload=None, **kwargs):
    engine = _aurora_native_evolved_engine()
    if engine is None:
        return {
            'available': False, 'reason': 'evolved_surface_engine_unavailable', 'op_id': 'aurora_dimensional_systems.EnergyRegulatorSystem._update_links_for_facet', 'kind': 'reflection'
        }
    return getattr(engine, 'reflect_aurora_dimensional_systems_energyregulatorsystem_update_links_for_facet')(payload=payload, **kwargs)

def tick_evolved(payload=None, **kwargs):
    engine = _aurora_native_evolved_engine()
    if engine is None:
        return {
            'available': False, 'reason': 'evolved_surface_engine_unavailable', 'op_id': 'aurora_dimensional_systems.EnergyRegulatorSystem.tick', 'kind': 'reflection'
        }
    return getattr(engine, 'reflect_aurora_dimensional_systems_energyregulatorsystem_tick')(payload=payload, **kwargs)

if _aurora_get_target(['EnergyRegulatorSystem', 'tick']) is not None:
    _AURORA_NATIVE_EVOLVED_ORIGINALS['EnergyRegulatorSystem.tick'] = _aurora_get_target(['EnergyRegulatorSystem', 'tick'])
    _aurora_assign_target(['EnergyRegulatorSystem', 'tick'], _aurora_make_override('tick_evolved', 'EnergyRegulatorSystem.tick'))
    _AURORA_NATIVE_EVOLVED_LAST['EnergyRegulatorSystem.tick'] = {'alignment_gap': 0.560666, 'override_active': True}
...
if _aurora_get_target(['_PoolView', 'inject']) is not None:
    ...
    _AURORA_NATIVE_EVOLVED_LAST['_PoolView.inject'] = {'alignment_gap': 0.567333, 'override_active': True}

AURORA_NATIVE_EVOLVED_EXPORTS = {'aurora_dimensional_systems.DimensionalSystems._current_pressure_vec': 'current_pressure_vec_evolved',
 'aurora_dimensional_systems.EnergyRegulatorSystem._update_links_for_facet': 'update_links_for_facet_evolved',
 'aurora_dimensional_systems.EnergyRegulatorSystem.tick': 'tick_evolved',
 'aurora_dimensional_systems._PoolView.inject': 'inject_evolved',
 'latent.aurora_dimensional_systems.CrystalProcessingSystem.process.develop_agency': 'process_develop_agency',
 'latent.aurora_dimensional_systems.DimensionalSystems.develop_agency': 'dimensionalsystems_develop_agency',
 'latent.aurora_dimensional_systems.EnergyRegulatorSystem.develop_agency': 'energyregulatorsystem_develop_agency',
 'latent.aurora_dimensional_systems.EvolutionTracker.develop_agency': 'develop_agency',
 'latent.aurora_dimensional_systems.MemoryConstantSystem.develop_agency': 'memoryconstantsystem_develop_agency',
 'latent.aurora_dimensional_systems.MoralityMortalitySystem.develop_agency': 'moralitymortalitysystem_develop_agency',
 'latent.aurora_dimensional_systems._PoolView.energy.develop_agency': 'energy_develop_agency'}
AURORA_NATIVE_EVOLUTION_OVERRIDES = {'aurora_dimensional_systems.DimensionalSystems._current_pressure_vec': {'export': 'current_pressure_vec_evolved',
                                                                         'mode': 'callable_override',
                                                                         'target': 'DimensionalSystems._current_pressure_vec'},
 'aurora_dimensional_systems.EnergyRegulatorSystem.tick': {'export': 'tick_evolved',
                                                           'mode': 'callable_override',
                                                           'target': 'EnergyRegulatorSystem.tick'},
 'aurora_dimensional_systems._PoolView.inject': {'export': 'inject_evolved',
                                                 'mode': 'callable_override',
                                                 'target': '_PoolView.inject'},
 'latent.aurora_dimensional_systems.CrystalProcessingSystem.process.develop_agency': {'export': 'process_develop_agency',
                                                                                      'mode': 'latent_binding',
                                                                                      'target': 'CrystalProcessingSystem.process.develop_agency'},
 'latent.aurora_dimensional_systems.DimensionalSystems.develop_agency': {'export': 'dimensionalsystems_develop_agency',
                                                                         'mode': 'latent_binding',
                                                                         'target': 'DimensionalSystems.develop_agency'},
 'latent.aurora_dimensional_systems.EnergyRegulatorSystem.develop_agency': {'export': 'energyregulatorsystem_develop_agency',
                                                                            'mode': 'latent_binding',
                                                                            'target': 'EnergyRegulatorSystem.develop_agency'},
 'latent.aurora_dimensional_systems.EvolutionTracker.develop_agency': {'export': 'develop_agency',
                                                                       'mode': 'latent_binding',
                                                                       'target': 'EvolutionTracker.develop_agency'},
 'latent.aurora_dimensional_systems.MemoryConstantSystem.develop_agency': {'export': 'memoryconstantsystem_develop_agency',
                                                                           'mode': 'latent_binding',
                                                                           'target': 'MemoryConstantSystem.develop_agency'},
 'latent.aurora_dimensional_systems.MoralityMortalitySystem.develop_agency': {'export': 'moralitymortalitysystem_develop_agency',
                                                                              'mode': 'latent_binding',
                                                                              'target': 'MoralityMortalitySystem.develop_agency'}}
