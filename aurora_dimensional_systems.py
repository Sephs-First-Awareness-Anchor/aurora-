# Re-export shim: delegate the bare module name `aurora_dimensional_systems` to its real
# implementation in aurora_core_ai/.
#
# The previous body was `from aurora_dimensional_systems import *`, which self-imported THIS stub
...
# `from aurora_dimensional_systems import GrammarEngine` raised ImportError. When repo-root sits
...
_REAL = _os.path.join(_CORE, "aurora_dimensional_systems.py")
