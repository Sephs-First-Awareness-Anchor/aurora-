...
_AURORA_NATIVE_STRATEGIES = {'LayerEnergyAccountant.develop_agency': {'ability_hits': 0,
                                          'alignment_gap': 0.0,
                                          ...
                                          'effect_phrases': ['would extend agency pressure '
                                                             ...
                                                             'aurora_internal.aurora_energy_layer_costs.LayerEnergyAccountant'],
                                          'genealogy_pressure': 0.0,
                                          'inheritance_breach_count': 0,
                                          'kind': 'latent',
                                          'link_hits': 0,
                                          'module': 'aurora_internal.aurora_energy_layer_costs',
                                          'op_id': 'latent.aurora_internal.aurora_energy_layer_costs.LayerEnergyAccountant.develop_agency',
                                          'origin_activity': 0,
...
def develop_agency(payload=None, **kwargs):
    ...
    if engine is None:
        return {
            'available': False, 'reason': 'evolved_surface_engine_unavailable', 'op_id': 'latent.aurora_internal.aurora_energy_layer_costs.LayerEnergyAccountant.develop_agency', 'kind': 'latent'
        }
    return getattr(engine, 'latent_aurora_internal_aurora_energy_layer_costs_layerenergyaccountant_develop_agency')(payload=payload, **kwargs)

_aurora_existing_binding = _aurora_get_target(['LayerEnergyAccountant'])
if _aurora_existing_binding is not None:
    _aurora_existing_attr = getattr(_aurora_existing_binding, 'develop_agency', None)
    if _aurora_existing_attr is None or getattr(_aurora_existing_attr, '_aurora_latent_binding_target', '') == 'LayerEnergyAccountant.develop_agency':
        _aurora_bind_owner_attribute(['LayerEnergyAccountant'], 'develop_agency', _aurora_make_latent_binding('develop_agency', 'LayerEnergyAccountant.develop_agency'))
        _AURORA_NATIVE_EVOLVED_LAST['LayerEnergyAccountant.develop_agency'] = {'latent_binding_active': True}

AURORA_NATIVE_EVOLVED_EXPORTS = {'latent.aurora_internal.aurora_energy_layer_costs.LayerEnergyAccountant.develop_agency': 'develop_agency'}
AURORA_NATIVE_EVOLUTION_OVERRIDES = {'latent.aurora_internal.aurora_energy_layer_costs.LayerEnergyAccountant.develop_agency': {'export': 'develop_agency',
                                                                                           'mode': 'latent_binding',
                                                                                           'target': 'LayerEnergyAccountant.develop_agency'}}
