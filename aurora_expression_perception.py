# Re-export shim: delegate the bare module name `aurora_expression_perception` to its real
# implementation in aurora_core_ai/.
#
# The previous body was `from aurora_expression_perception import *`, which self-imported THIS stub
...
# `from aurora_expression_perception import GrammarEngine` raised ImportError. When repo-root sits
...
_REAL = _os.path.join(_CORE, "aurora_expression_perception.py")
