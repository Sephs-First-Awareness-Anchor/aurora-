...
class DualStrataBridge:
    ...
    def _build_subsurface_state(
        ...
        *,
        ...
        if poedex_learning_result or poedex_learning_note:
            candidate_interpretations.append(
                {
        ...
        if poedex_representation_result or poedex_representation_variants:
            candidate_interpretations.append(
                {
                    "label": "poedex_representation_context",
                    "confidence": 0.57,
                    "summary": (
                        f"Poedex representation for {poedex_representation_concept}: {poedex_representation_variants[0]}"
                        if poedex_representation_concept and poedex_representation_variants else
        ...
        *,
        ...
        root_seed_candidates = [
            ...
            (
                ...
                if poedex_prefetch_result and poedex_prefetch_concept else
                f"Poedex context: {poedex_prefetch_result}"
                if poedex_prefetch_result else
                ""
            ),
        ...
        if poedex_representation_result or poedex_representation_variants:
            if poedex_representation_concept:
                root_summary_parts.append(
                    f"Poedex representation for {poedex_representation_concept}: {poedex_representation_variants[0] if poedex_representation_variants else poedex_representation_result}."
                )
            else:
        ...
        if poedex_representation_result or poedex_representation_variants:
            if poedex_representation_concept:
                explicit_notes.append(
                    f"Poedex representation: {poedex_representation_concept} -> {poedex_representation_variants[0] if poedex_representation_variants else poedex_representation_result}"
                )
            else:
