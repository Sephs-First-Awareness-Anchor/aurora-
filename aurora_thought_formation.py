...
# Re-export shim: delegate the bare module name `aurora_thought_formation` to its real
# implementation in aurora_core_ai/.
#
# The previous body was `from aurora_thought_formation import *`, which self-imported THIS stub
...
# `from aurora_thought_formation import GrammarEngine` raised ImportError. When repo-root sits
...
_REAL = _os.path.join(_CORE, "aurora_thought_formation.py")
