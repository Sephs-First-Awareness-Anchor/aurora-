...
# Re-export shim: delegate the bare module name `aurora_i_state_beings` to its real
# implementation in aurora_core_ai/.
#
# The previous body was `from aurora_i_state_beings import *`, which self-imported THIS stub
...
# `from aurora_i_state_beings import GrammarEngine` raised ImportError. When repo-root sits
...
_REAL = _os.path.join(_CORE, "aurora_i_state_beings.py")
