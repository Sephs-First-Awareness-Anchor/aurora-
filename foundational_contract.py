...
# Re-export shim: delegate the bare module name `foundational_contract` to its real
# implementation in aurora_core_ai/.
#
# The previous body was `from foundational_contract import *`, which self-imported THIS stub
...
# `from foundational_contract import GrammarEngine` raised ImportError. When repo-root sits
...
_REAL = _os.path.join(_CORE, "foundational_contract.py")
