...
# Re-export shim: delegate the bare module name `aurora_ivm` to its real
# implementation in aurora_core_ai/.
#
# The previous body was `from aurora_ivm import *`, which self-imported THIS stub
...
# `from aurora_ivm import GrammarEngine` raised ImportError. When repo-root sits
...
_REAL = _os.path.join(_CORE, "aurora_ivm.py")
