...
# Re-export shim: delegate the bare module name `aurora_grammar_engine` to its real
# implementation in aurora_core_ai/.
#
# The previous body was `from aurora_grammar_engine import *`, which self-imported THIS stub
...
# `from aurora_grammar_engine import GrammarEngine` raised ImportError. When repo-root sits
...
_REAL = _os.path.join(_CORE, "aurora_grammar_engine.py")
