...
# Re-export shim: delegate the bare module name `corpus_runner` to its real
# implementation in aurora_core_ai/.
#
# The previous body was `from corpus_runner import *`, which self-imported THIS stub
...
# `from corpus_runner import GrammarEngine` raised ImportError. When repo-root sits
...
_REAL = _os.path.join(_CORE, "corpus_runner.py")
